...
%     avg_mat1 = reshape(cell2mat(avg_mean),sample_length,spoke_count);
    avg_mean = avg_spoked1;
    avg_mat1 = reshape(avg_mean,sample_length,spoke_count);
...
%     avg_mat2 = reshape(cell2mat(avg_mean),sample_length,spoke_count);
    avg_mean = avg_spoked2;
    avg_mat2 = reshape(avg_mean,sample_length,spoke_count);
...
%     avg_mat3 = reshape(cell2mat(avg_mean),sample_length,spoke_count);
    avg_mean = avg_spoked3;
    avg_mat3 = reshape(avg_mean,sample_length,spoke_count);
